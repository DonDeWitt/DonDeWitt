...
public class ListArrayBased implements ListInterface
{
    ...
    protected int MAX_LIST = 3; //fixes programming style
    ...
    throws  ListIndexOutOfBoundsException
    {
        ...
        ***/
        if (index >= 0 && index <= numItems && items[index] != null) //fixes implementation error
        {
        ...
        else if(index >= 0 && index < MAX_LIST && items[index] == null) //fixes implementation error
        {
            items[index] = item;
            numItems++;
        }
